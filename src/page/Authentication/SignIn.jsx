  ...
  if (logining) {
    return (
      <div className=" w-[100vw]">
        <div
          id="preloader"
          className="z-999999 mx-auto flex h-[100vh]  items-center justify-center "
        >
    ...
    return (
      <>
        <div className=" rounded-sm bg-white shadow-default dark:border-strokedark dark:bg-boxdark md:overflow-hidden">
          <div className="flex max-h-[100vh] content-center items-center overflow-hidden">
            ...
            <div className="w-full  xl:w-1/2 xl:border-l-2">
              <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                  Sign In to TECHNO IWASA Admin Dashboard
                </h2>
                ...
                <form onSubmit={handleSubmitLoginForm}>
                  ...
                  <div className="text-left w-full">
                    <label className="text-black font-medium text-left">
                      Password
                    </label>
                    <div className="relative  mt-2">
                      <div
                        type="reset"
                        className="text-gray-600 absolute right-3 flex items-center inset-y-0 my-auto active:text-gray-600 "
                      ...
                      <input
                        ...
                        name="password"
                        className="w-full  py-4 px-6 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg"
                      />
                    </div>
                  </div>
                  ...
                  <div className="my-5 w-full">
                    <button
                      type="submit"
                      className=" w-full text-white duration-150 bg-indigo-600 rounded-lg hover:bg-indigo-500 active:bg-indigo-700"
                    >
                      Log in
                    </button>
                  </div>
